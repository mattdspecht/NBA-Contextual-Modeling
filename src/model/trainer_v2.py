...
def main():
    ...
    joblib.dump(best_pipeline, os.path.join(models_dir, "v2_mean_pipeline.pkl"))
    joblib.dump(q10_pipe, os.path.join(models_dir, "v2_q10_pipeline.pkl"))
    joblib.dump(q90_pipe, os.path.join(models_dir, "v2_q90_pipeline.pkl"))
    joblib.dump(lgbm_pipeline, os.path.join(models_dir, "lgbm_v2_pipeline.pkl"))
    joblib.dump(xgb_pipeline, os.path.join(models_dir, "xgb_v2_pipeline.pkl"))
    # Save both pipelines for ensemble at inference time
    joblib.dump({"lgbm": lgbm_pipeline, "xgb": xgb_pipeline},
                os.path.join(models_dir, "v2_ensemble_pipelines.pkl"))
    ...
    with open(os.path.join(models_dir, "model_v2_metrics.json"), "w") as f:
    ...
    print("\n  Saved:")
    print("    models/v2_mean_pipeline.pkl       ← best single model")
    print("    models/v2_ensemble_pipelines.pkl  ← both models for ensemble")
    print("    models/v2_q10_pipeline.pkl        ← P10 quantile")
    print("    models/v2_q90_pipeline.pkl        ← P90 quantile")
    print("    models/model_v2_metrics.json")
    print("    visualizations/06_v2_feature_importance.png")
